...
namespace Picker.Patcher.Setup
{
    partial class MainForm
    {
        ...
        private void InitializeComponent() {
            ...
            this.toolTipButtons.SetToolTip(this.buttonSetup, "Complete environment setup for working on Picker source\r\nEquivalent to Decomp" +
        "ile+Patch+SetupDebug\r\nEdit the source in src/Picker then run Diff Picker" +
        ...
        "the client binary\r\nOutputs to src/decompiled");
            ...
            this.buttonDiffTerraria.Text = "Diff PickCrafter";
            this.toolTipButtons.SetToolTip(this.buttonDiffTerraria, "Recalculates the PickCrafter patches\r\nDiffs the src/PickCrafter directory\r\nUsed for fix" +
        "ing decompilation errors\r\n");
            ...
            this.buttonPatchTerraria.Text = "Patch PickCrafter";
        ...
        "source is located in src/PickCrafter");
            ...
            this.buttonPatchModLoader.Text = "Patch Picker";
            this.toolTipButtons.SetToolTip(this.buttonPatchModLoader, "Applies Picker patches to PickCrafter\r\nEdit the source code in src/Picker af" +
        "ter this phase\r\nInternally formats the PickCrafter sources before patching");
            ...
            this.buttonDiffModLoader.Text = "Diff Picker";
