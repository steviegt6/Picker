...
using Picker.Patcher.Properties;
using static Picker.Patcher.Setup.Program;
...
namespace Picker.Patcher.Setup
{
	public partial class MainForm : Form, ITaskInterface
	{
		...
		public MainForm()
		{
			...
			taskButtons[buttonDiffTerraria] = () => new DiffTask(this, "src/decompiled", "src/PickCrafter", "patches/PickCrafter", new ProgramSetting<DateTime>("TerrariaDiffCutoff"));
			taskButtons[buttonPatchTerraria] = () => new PatchTask(this, "src/decompiled", "src/PickCrafter", "patches/PickCrafter", new ProgramSetting<DateTime>("TerrariaDiffCutoff"));
			taskButtons[buttonDiffModLoader] = () => new DiffTask(this, "src/PickCrafter", "src/Picker", "patches/Picker", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonPatchModLoader] = () => new PatchTask(this, "src/PickCrafter", "src/Picker", "patches/Picker", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
